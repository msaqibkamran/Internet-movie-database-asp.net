...
function ValidateEmail() {
 ...
 if (/^\w+([\.-]?\w+)*@\w+([\.-]?\w+)*(\.\w{2,3})+$/.test(document.getElementById('signup-email').value)) {
    return (true);
  }
  else {
    document.getElementById('signup-email').value = "";
    document.getElementById('signup-email').className += " Red";
    document.getElementById('signup-email').placeholder = "Invalid email Address!";
    return false; 
  }
...
function checkpass() {
  ...
  if(document.getElementById('signup-pass').value.match(passw)){
    return true;
  }
  else {
    document.getElementById('signup-pass').value = "";
    document.getElementById('signup-pass').className += " Red";
    document.getElementById('signup-pass').placeholder = "Pass must be at least 6 dig,1 num,1 upper,1 lower !";
    return false; 
  }
}
...
{ 
  ...
  if(document.getElementById('signup-username2').value.match(letters))
  {
    return true;
  }
  else
  {
   document.getElementById('signup-username2').value = "";
    document.getElementById('signup-username2').className += " Red";
    document.getElementById('signup-username2').placeholder = "Username can contains letters and nums only!";
    return false; 
  }
}
